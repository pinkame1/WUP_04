...
the chances of these categories to the same is 0.000236 which is also our pr. So, this defends our case that these can be very similar but never the same.
